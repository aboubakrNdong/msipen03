...
class GlobalExceptionHandlerTest {
    ...
    void handleRemittanceNotFoundException_ShouldReturnNotFoundStatus() {
        RemittanceNotFoundException ex = new RemittanceNotFoundException("ReferenceComete not found for ID: ");

        ResponseEntity<Map<String, Object>> response = handler.handleRemittanceNotFoundException(ex);
        ...
        assertThat(body)
                ...
                .containsEntry("error", "Reference comete not found");
    }
    ...
    void handleDataAccessException_ShouldReturnInternalServerError() {
        ...
        ResponseEntity<Map<String, Object>> response = handler.handleDataAccess(ex);
        Map<String, Object> body = response.getBody();
