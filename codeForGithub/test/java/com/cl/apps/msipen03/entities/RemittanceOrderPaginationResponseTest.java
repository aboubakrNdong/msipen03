...
class RemittanceOrderPaginationResponseTest {
    ...
    void testShouldCreatePaginationResponse() {
        ...
        assertThat(response)
                .extracting(
                        RemittanceOrderPaginationResponse::size,
                        RemittanceOrderPaginationResponse::page,
                        RemittanceOrderPaginationResponse::total
                )
                .containsExactly(10, 0, 2L);
    ...
    void testShouldSerializeToJson() throws Exception {
        ...
        assertThat(json)
                ...
                .contains("\"page\":0")
                .contains("\"total\":1")
                .contains("\"COMPTE_RENDU_DE_TRAITEMENT_DE_LA_REMISE\":")
                .contains("\"DETAIL_DES_OPERATIONS_DE_LA_REMISE \":");
    }
