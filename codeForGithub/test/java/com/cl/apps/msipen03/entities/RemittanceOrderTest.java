...
class RemittanceOrderTest {
    ...
    void testShouldCreateRemittanceOrder() {
        RemittanceOrder order = createOrder("IPF000000127641", 10, "REM000000101066", new BigDecimal("1500"));

        assertThat(order.getReferenceBanqueDeLaRemise()).isEqualTo("REM000000101066");
    ...
    void testShouldSerializeToJson() throws Exception {
        ...
        assertThat(json).contains("\"referenceBanqueDeLaRemise\":\"REM000000101065\"")
                .contains("\"statutDeLaRemise\":\"ACCEPTED\"")
                .contains("\"libelleDuCompteDO\":\"COMPTE COURANT\"")
                .contains("\"compteDO\":\"FR7630006000011234567890189\"")
                .contains("\"nombreVirements\":3");
    }
}