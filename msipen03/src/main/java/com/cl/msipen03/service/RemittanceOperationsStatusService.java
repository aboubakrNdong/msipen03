...
public class RemittanceOperationsStatusService {
    ...
    public Page<RemittanceOperationRequest> getRemittanceOperationResponse(String paymentInfId, int page, int size) {
        LOGGER.info("Start - RemittanceOperationService: getRemittanceOperationResponse: ");
        return databaseRepository.listRemittanceOperation(paymentInfId, page, size);
    }
